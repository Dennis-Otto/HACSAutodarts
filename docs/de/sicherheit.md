...
| Skripteinschleusung über Board- oder Gerätenamen in den Karten | Jeder eingefügte Text wird maskiert; kein `innerHTML` mit unmaskierten Daten | fast-check-Eigenschaft „maskierter Text enthält nie Markup“ |
