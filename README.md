...
- **Practice games.** Play X01 (301, 501 or 701) on the local board. The remaining score counts down, busts are recognised, and the live card shows the checkout route and the bed to aim at.
...
| Board events | Dart detected and corrected, takeout started and finished, visit completed, status changed, session started and ended, bust, leg won | ✓ | ✓ |
...
| Practice game | X01 with 301, 501 or 701, double out, remaining score, busts, checkout routes and the last 10 legs | ✓ | ✓ |
